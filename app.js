...
import { Department, Course, Exam, Question , addCourse , addDeprtment, getDepartments, addExam, getExams, getExam } from './models/Department.js'
...
app.get('/explore', (req, res) => {
        ...
        getDepartments().then(departments => res.render('main', { user: 'admin', departments: departments, page:'explore'}))
...
app.get('/courses/:department/:course/exams/:examType/:exam', (req, res) => {
        ...
        getExam(req.params.exam, req.params.course,req.params.examType).then(exam => {
                console.log(exam)
                res.render('main', { examName: req.params.exam, user: 'admin', questions: exam.questions, page: 'exam' })
        })
...
app.post('/courses/:department/:course/exams/:examType/:exam/reviewExam', (req, res) => {
        ...
        getExam(req.params.exam, req.params.course, req.params.examType).then(exam => {
                        res.render('main', {user: 'admin',recivedAnsewrs:Object.values(req.body) ,questions: exam.questions, correctAnswers: exam.correctAnswers, page:'review'})
        })
...
app.post('/courses/:department/:course/add/:examType/exam/data', (req, res) => {
        ...
        let exam = {examType:examType,courseName:courseName, header: examName, description: examDescription, questions: questions, correctAnswers: correctAnswer }
        console.log(exam)
...
app.post('/explore/add/:department/courses', (req, res) => {
        console.log(req.body)//add those data to database
        addCourse({ header: req.body.ID , description: req.body.description, departmentName: req.params.department })
